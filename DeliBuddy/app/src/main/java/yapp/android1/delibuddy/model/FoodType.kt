...
internal sealed class FoodType(
    val type: String,
    ...
    object Cafe : FoodType(type = "Cafe", colorResource = R.color.cafe_background, bigIconResource = R.drawable.big_food_icon_cafe)
    ...
    object Snackbar : FoodType(type = "Snackbar", colorResource = R.color.snackbar_background, bigIconResource = R.drawable.big_food_icon_snackbar)
